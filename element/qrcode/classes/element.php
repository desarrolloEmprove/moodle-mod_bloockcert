...
/**
 * This file contains the bloockcert element QR code's core interaction API.
 *
 * @package    bloockcertelement_qrcode
 * @copyright  2024 Edwin Martínez <desarrollo@emprove.com.mx>
 * @copyright  2019 based on work by Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace bloockcertelement_qrcode;
...
/**
 * The bloockcert element QR code's core interaction API.
 *
 * @package    bloockcertelement_qrcode
 * @copyright  2024 Edwin Martínez <desarrollo@emprove.com.mx>
 * @copyright  2019 based on work by Mark Nelson <markn@moodle.com>
...
class element extends \mod_bloockcert\element {
    ...
    public function validate_form_elements($data, $files) {
        ...
        // Validate the width.
        $errors += \mod_bloockcert\element_helper::validate_form_element_width($data, false);

        // Validate the height.
        $errors += \mod_bloockcert\element_helper::validate_form_element_height($data, false);
    ...
    public function render($pdf, $preview, $user) {
        ...
        if ($preview) {
            ...
            // Generate the URL to verify this.
            $qrcodeurl = new \moodle_url('/mod/bloockcert/verify_certificate.php',
                [
