...
/**
 * This file contains the bloockcert element coursefield's core interaction API.
 *
 * @package    bloockcertelement_coursefield
 * @copyright  2019 Catalyst IT
 * @author     Dan Marsden
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace bloockcertelement_coursefield;

/**
 * The bloockcert element coursefield's core interaction API.
 *
 * @package    bloockcertelement_coursefield
 * @copyright  2019 Catalyst IT
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class element extends \mod_bloockcert\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('select', 'coursefield', get_string('coursefield', 'bloockcertelement_coursefield'), $fields);
        $mform->setType('coursefield', PARAM_ALPHANUM);
        $mform->addHelpButton('coursefield', 'coursefield', 'bloockcertelement_coursefield');
    ...
    public function render($pdf, $preview, $user) {
        ...
        \mod_bloockcert\element_helper::render_content($pdf, $this, $this->get_course_field_value($course, $preview));
    }
    ...
    public function render_html() {
        ...
        return \mod_bloockcert\element_helper::render_html_content($this, $this->get_course_field_value($COURSE, true));
    }
