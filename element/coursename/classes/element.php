...
/**
 * This file contains the bloockcert element coursename's core interaction API.
 *
 * @package    bloockcertelement_coursename
...
namespace bloockcertelement_coursename;

/**
 * The bloockcert element coursename's core interaction API.
 *
 * @package    bloockcertelement_coursename
 * @copyright  2024 Edwin Martinez <desarrollo@emprove.com.mx>
 * @copyright  2013 based on work by Mark Nelson <markn@moodle.com>
...
class element extends \mod_bloockcert\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('select', 'coursenamedisplay', get_string('coursenamedisplay', 'bloockcertelement_coursename'),
            self::get_course_name_display_options());
        $mform->setType('coursenamedisplay', PARAM_INT);
        $mform->addHelpButton('coursenamedisplay', 'coursenamedisplay', 'bloockcertelement_coursename');
    ...
    public function render($pdf, $preview, $user) {
        \mod_bloockcert\element_helper::render_content($pdf, $this, $this->get_course_name_detail());
    }
    ...
    public function render_html() {
        return \mod_bloockcert\element_helper::render_html_content($this, $this->get_course_name_detail());
    }
    ...
    public static function get_course_name_display_options(): array {
        return [
            self::COURSE_FULL_NAME => get_string('coursefullname', 'bloockcertelement_coursename'),
            self::COURSE_SHORT_NAME => get_string('courseshortname', 'bloockcertelement_coursename')
        ];
    }
}
