...
/**
 * This file contains the bloockcert element userfield's core interaction API.
 *
 * @package    bloockcertelement_userfield
...
namespace bloockcertelement_userfield;

use core_user\fields;

/**
 * The bloockcert element userfield's core interaction API.
 *
 * @package    bloockcertelement_userfield
 * @copyright  2024 Edwin Martinez <desarrollo@emprove.com.mx>
 * @copyright  2013 based on work by Mark Nelson <markn@moodle.com>
...
class element extends \mod_bloockcert\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('select', 'userfield', get_string('userfield', 'bloockcertelement_userfield'), $fields);
        $mform->setType('userfield', PARAM_ALPHANUM);
        $mform->addHelpButton('userfield', 'userfield', 'bloockcertelement_userfield');
    ...
    public function render($pdf, $preview, $user) {
        \mod_bloockcert\element_helper::render_content($pdf, $this, $this->get_user_field_value($user, $preview));
    }
    ...
    public function render_html() {
        ...
        return \mod_bloockcert\element_helper::render_html_content($this, $this->get_user_field_value($USER, true));
    }
