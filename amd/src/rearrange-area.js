 ...
 *
 * @module     mod_bloockcert/rearrange-area
 ...
 */
define(['jquery', 'core/yui', 'core/fragment', 'mod_bloockcert/dialogue', 'core/notification',
        ...
        function($, Y, fragment, Dialogue, notification, str, template, ajax) {
            ...
            RearrangeArea.prototype.BLOOCKCERT_REF_POINT_TOPLEFT = 0;
            RearrangeArea.prototype.BLOOCKCERT_REF_POINT_TOPCENTER = 1;
            RearrangeArea.prototype.BLOOCKCERT_REF_POINT_TOPRIGHT = 2;
            ...
            RearrangeArea.prototype._editElement = function(event) {
                ...
                fragment.loadFragment('mod_bloockcert', 'editelement', contextid, params).done(function(html, js) {
                    str.get_string('editelement', 'mod_bloockcert').done(function(title) {
                ...
                body.on('click', '#id_submitbutton', function(e) {
                    ...
                    this._saveElement(elementid).then(function() {
                        ...
                        this._getElementHTML(elementid).done(function(html) {
                            ...
                            var refpointClass = '';
                            if (refpoint == this.BLOOCKCERT_REF_POINT_TOPLEFT) {
                                refpointClass = 'refpoint-left';
                            } else if (refpoint == this.BLOOCKCERT_REF_POINT_TOPCENTER) {
                                refpointClass = 'refpoint-center';
                            } else if (refpoint == this.BLOOCKCERT_REF_POINT_TOPRIGHT) {
            ...
            RearrangeArea.prototype._setPosition = function(elementid, refpoint, posx, posy) {
                ...
                switch (refpoint) {
                    case this.BLOOCKCERT_REF_POINT_TOPCENTER:
                        posx -= nodewidth / 2;
                        break;
                    case this.BLOOCKCERT_REF_POINT_TOPRIGHT:
            ...
            RearrangeArea.prototype._getElementHTML = function(elementid) {
                ...
                var promises = ajax.call([{
                    methodname: 'mod_bloockcert_get_element_html',
                    args: {
            ...
            RearrangeArea.prototype._saveElement = function(elementid) {
                ...
                var promises = ajax.call([{
                    methodname: 'mod_bloockcert_save_element',
                    args: {
                        templateid: templateid,
                        elementid: elementid,
                        values: inputs
