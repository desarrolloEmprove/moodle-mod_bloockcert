...
class element_helper_test extends advanced_testcase {
    ...
    /**
     * Tests we are returning the correct course id for an element in a course bloockcert activity.
     *
    ...
    public function test_get_courseid_element_in_course_certificate() {
        ...
        $template = $DB->get_record('bloockcert_templates', array('contextid' => context_module::instance($bloockcert->cmid)->id));
    ...
    /**
     * Tests we are returning the correct course module id for an element in a course bloockcert activity.
     *
    ...
    public function test_get_context_element_in_course_certificate() {
        ...
        $this->assertEquals(context_module::instance($bloockcert->cmid),
