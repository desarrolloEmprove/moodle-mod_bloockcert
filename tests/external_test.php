...
class external_test extends advanced_testcase {
    ...
    public function test_delete_issue() {
        ...
        $i1 = certificate::issue_certificate($bloockcert->id, $student1->id);
        $i2 = certificate::issue_certificate($bloockcert->id, $student2->id);

        $this->assertEquals(2, $DB->count_records('bloockcert_issues'));

        $result = external::delete_issue($bloockcert->id, $i2);
    ...
    public function test_delete_issue_no_login() {
        ...
        external::delete_issue($bloockcert->id, $i2);
    }
