...
/**
 * Unit tests for mod_bloockcert lib.
 *
...
class lib_test extends advanced_testcase {
     ...
     *
     * @covers ::mod_bloockcert_force_current_language
     */
    public function test_mod_bloockcert_force_current_language() {
        global $USER;
        ...
        foreach ($testlangs as $lang) {
            $forced = mod_bloockcert_force_current_language($lang);
            $this->assertFalse($forced);
            $this->assertArrayNotHasKey($lang, $activelangs);
        }

        // Testing english language.
        $forced = mod_bloockcert_force_current_language('en');
        $this->assertFalse($forced);
