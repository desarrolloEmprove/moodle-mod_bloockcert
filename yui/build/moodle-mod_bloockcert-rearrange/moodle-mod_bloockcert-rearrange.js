YUI.add('moodle-mod_bloockcert-rearrange', function (Y, NAME) {

/**
 * Rearrange elements in the custom certificate
 *
 * @class Y.M.mod_bloockcert.rearrange
 * @constructor
 */
...
Y.extend(Rearrange, Y.Base, {
    ...
    /**
     * The bloockcert page we are displaying.
     */
    page: [],
    ...
    savepositions: function(e) {
        ...
        Y.io(M.cfg.wwwroot + '/mod/bloockcert/ajax.php', {
            method: 'POST',
            data: params,
            on: {
...
Y.namespace('M.mod_bloockcert.rearrange').init = function(templateid, page, elements) {
