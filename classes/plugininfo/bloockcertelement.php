 ...
 */
namespace mod_bloockcert\plugininfo;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bloockcertelement extends base {

    /**
     * Do not allow users to uninstall these plugins as it could cause bloockcerts to break.
     *
     * @return bool
     */
    ...
    public function get_settings_section_name() {
        if (file_exists($this->full_path('settings.php'))) {
            return 'bloockcertelement_' . $this->name;
        } else {
            return null;
        }
    }
