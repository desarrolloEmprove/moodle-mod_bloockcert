...
class email_certificate implements \renderable, \templatable {
    ...
    public function export_for_template(\renderer_base $renderer) {
        ...
        if ($this->isstudent) {
            $data->emailgreeting = get_string('emailstudentgreeting', 'bloockcert', $this->userfullname);
            $data->emailbody = get_string('emailstudentbody', 'bloockcert', $info);
            $data->emailbodyplaintext = get_string('emailstudentbodyplaintext', 'bloockcert', $info);
            $data->emailcertificatelink = new \moodle_url('/mod/bloockcert/view.php', array('id' => $this->cmid));
            $data->emailcertificatetext = get_string('emailstudentcertificatelinktext', 'bloockcert');
        } else {
            $data->emailgreeting = get_string('emailnonstudentgreeting', 'bloockcert');
            $data->emailbody = get_string('emailnonstudentbody', 'bloockcert', $info);
            $data->emailbodyplaintext = get_string('emailnonstudentbodyplaintext', 'bloockcert', $info);
            $data->emailcertificatelink = new \moodle_url('/mod/bloockcert/view.php', array('id' => $this->cmid));
            $data->emailcertificatetext = get_string('emailnonstudentcertificatelinktext', 'bloockcert');
        }
