...
class element_deleted extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'bloockcert_elements';
    }
    ...
    public static function get_name() {
        return get_string('eventelementdeleted', 'bloockcert');
    }

    /**
     * Create instance of event.
     *
     * @param \mod_bloockcert\element $element
     * @return element_deleted
     */
    public static function create_from_element(\mod_bloockcert\element $element) : element_deleted {
        global $DB;

        $page = $DB->get_record('bloockcert_pages', ['id' => $element->get_pageid()]);
        $template = $DB->get_record('bloockcert_templates', ['id' => $page->templateid]);
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'bloockcert_elements', 'restore' => 'bloockcert_elements');
    }
